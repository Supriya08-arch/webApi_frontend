...
import img from "../style/images/img.png";
      ...
      <div className="container">
        <div className="row  loginrow no-gutters">
          <div className="col-lg-5">
            {/* <img src={"https://images.unsplash.com/photo-1568667256549-094345857637?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bGlicmFyaWVzfGVufDB8fDB8fA%3D%3D&w=1000&q=80"} className="img-fluid login-img" /> */}
            
             <img src={img} className="img-fluid login-img" />
          </div>
